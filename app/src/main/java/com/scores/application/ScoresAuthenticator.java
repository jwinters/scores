...
import com.scores.activities.LoginActivity;

public class ScoresAuthenticator extends AbstractAccountAuthenticator {

	public static final String ACCOUNT_NAME = "Scores";
	public static final String ACCOUNT_TYPE = "com.scores.account";
	public static final String AUTH_TOKEN_TYPE = "com.scores.token";

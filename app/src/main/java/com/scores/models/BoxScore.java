...
import com.scores.datasets.BoxScoreTable.Columns;
...
public class BoxScore {
    ...
    @ColumnName(Columns.HOME_TIES)
    public Long getHomeTies() {
        return mTeamRecords != null ? mTeamRecords.getHomeTies() : null;
    }
    ...
    @ColumnName(Columns.AWAY_TIES)
    public Long getAwayTies() {
        return mTeamRecords != null ? mTeamRecords.getAwayTies() : null;
    }
